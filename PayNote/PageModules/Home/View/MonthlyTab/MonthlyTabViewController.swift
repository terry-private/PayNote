...
class MonthlyTabViewController: UIViewController, Transitioner {
    ...
    private var yearMonthList: [YearMonth] = Array(Cache.monthlyNotes.keys)
    // ボタン押下時の軽微な振動を追加する
    ...
    private func getMonthlyContentsDirection(selectedIndex: Int) -> UIPageViewController.NavigationDirection {
